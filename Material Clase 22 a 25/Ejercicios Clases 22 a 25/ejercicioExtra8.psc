...
SubProceso JuntarMatrices(repres_area Por Referencia, matriz Por Referencia)
	Definir i, j, op, op1 Como Entero
	matriz[0,0] = "               "
...
////  Consigna B
	Repetir
		...
		FinSegun
	Mientras Que op1>=1 Y op1<=4
	////  Consigna C
	Escribir " c) El total de ventas de todos los Representantes fue de ", matriz[5,6]
FinSubProceso
