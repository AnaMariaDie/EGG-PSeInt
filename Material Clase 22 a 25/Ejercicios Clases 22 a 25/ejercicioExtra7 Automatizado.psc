Algoritmo ejercicioExtra7
	Definir matrizEstadistica, Total_Producto, Total_Semana, ProdMasVen, num Como Entero
	...
	Repetir
		...
		Escribir " 1. Ventas Por Dia de la Semana "
		Escribir " 2. Ventas Por Producto en la Semana "
		Escribir " 3. Producto mas Vendido "
		Escribir " 4. Imprimir Cuadro Comparativo "
		Escribir " 0. Para Salir del Programa "
		Leer num
		Segun num Hacer
			1: calculoVentasXDia(Total_Semana,diaSemana)
			2: calculoVentasXProducto(Total_Producto,nomProducto)
			3: prodMasVendidoXDia(ProdMasVen,nomProducto)
				prodMasVendidoXSemana(matrizEstadistica,diaSemana,nomProducto)
			4: juntarMatrices(matrizEstadistica,matrizCuadro)
		FinSegun
	Mientras Que num <> 0
FinAlgoritmo
